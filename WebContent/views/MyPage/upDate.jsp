		...
		<form action="<%=request.getContextPath()%>/member.signUp" method="post">
			<table class="signUpTable">
				<tr>
					...
					<td colspan="2"><input type="text" name="id" id="id" value="<%=userid %>" readonly></td>
				</tr>
				...
				<tr>
					<td colspan="2" class="center">
						<button class="adminButton" id="submit" type="submit" >수정</button>
					</td>
					<td colspan="2" class="center">
						<button class="adminButton" id="mymainbtn" onclick="mymain();" >취소</button>
					</td>
				</tr>
			</table>
		</form>
